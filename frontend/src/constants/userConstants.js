export const USER_SIGININ_REQUEST = 'USER_SIGNIN_REQUEST';
export const USER_SIGININ_SUCCESS = 'USER_SIGININ_SUCCESS';
export const USER_SIGININ_FAIL = 'USER_SIGININ_FAIL';
